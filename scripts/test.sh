...
node "${ROOT_DIR}/scripts/check-authenticated-page-recovery.mjs"
...
node "${ROOT_DIR}/scripts/check-active-page-startup.mjs"
node "${ROOT_DIR}/scripts/check-workspace-loading.mjs"
node "${ROOT_DIR}/scripts/check-tab-reordering.mjs"
node "${ROOT_DIR}/scripts/check-memory-compaction.mjs"
zsh "${ROOT_DIR}/scripts/check-memory-compaction-webkit.sh"
